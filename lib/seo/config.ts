...
export const siteConfig = {
  ...
  keywords: [
    ...
    "desarrollador Oruro",
    "programador Bolivia",
    "arquitecto software Bolivia",
    "ingeniero sistemas Oruro",
    "consultor tecnología Bolivia",
    // Legal-Tech (diferenciador único)
    "Legal-Tech Bolivia",
    "abogado programador",
    "derecho digital Bolivia",
    "consultor legal tech",
    // Servicios
    "Conferencias tecnología",
    "Speaker Bolivia",
    "consultoría software",
    "desarrollo aplicaciones Bolivia",
    // Marca personal
    "David Morales Vega",
    "BeMoreX",
  ],
