...
| ✅ Incluir | ❌ Excluir |
|-----------|-----------|
| Páginas principales | Páginas de agradecimiento ("Gracias por tu compra") |
| Artículos del blog | Resultados de búsqueda interna |
| Páginas de servicios/productos | URLs con parámetros de tracking (?utm_source=) |
| Landing pages | Páginas de login/registro |
| Categorías importantes | Contenido duplicado o casi-duplicado |
...
Google asigna un "presupuesto de rastreo" basado en la autoridad de tu dominio. En sitios pequeños (<10,000 páginas) no es crítico. En sitios grandes, desperdiciar crawl budget es criminal.
